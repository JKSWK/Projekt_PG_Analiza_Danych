...
ggpiestats(
  ...
  x = previous_loan_defaults_on_file,
  y = person_gender,
>>>>>>> 3b6b0efa9e15aa4ef4f78a5e3aaac332db43e3b9
...
qqnorm(data_filtered$person_income, main = "Wykres QQ - Person Income")
qqline(data_filtered$person_income, col  ="red")

qqnorm(data_filtered$person_age, main = "Wykres QQ -  person_age")
qqline(data_filtered$person_age, col  ="red")

qqnorm(data_filtered$person_emp_exp, main = "Wykres QQ - person_emp_exp")
qqline(data_filtered$person_emp_exp, col  ="red")

qqnorm(data_filtered$loan_amnt, main = "Wykres QQ - loan_amnt")
qqline(data_filtered$loan_amnt, col  ="red")

qqnorm(data_filtered$loan_int_rate, main = "Wykres QQ - loan_int_rate")
qqline(data_filtered$loan_int_rate, col  ="red")

qqnorm(data_filtered$cb_person_cred_hist_length, main = "Wykres QQ - cb_person_cred_hist_length")
qqline(data_filtered$cb_person_cred_hist_length, col  ="red")

qqnorm(data_filtered$credit_score, main = "Wykres QQ - credit_score")
qqline(data_filtered$credit_score, col  ="red")
...
ad.test(data_filtered$person_income)
ad.test(data_filtered$person_age)
ad.test(data_filtered$person_emp_exp)
ad.test(data_filtered$loan_amnt)
ad.test(data_filtered$loan_int_rate)
ad.test(data_filtered$loan_percent_income)
ad.test(data_filtered$cb_person_cred_hist_length)
ad.test(data_filtered$credit_score)
ad.test(data_filtered$loan_status)
...
```{r}
lillie.test(data_filtered$person_income)
lillie.test(data_filtered$person_age)
lillie.test(data_filtered$person_emp_exp)
lillie.test(data_filtered$loan_amnt)
lillie.test(data_filtered$loan_int_rate)
lillie.test(data_filtered$loan_percent_income)
lillie.test(data_filtered$cb_person_cred_hist_length)
lillie.test(data_filtered$credit_score)
lillie.test(data_filtered$loan_status)
...
data_filtered$person_income_log <- log(data_filtered$person_income)
data_filtered$person_age_log <- log(data_filtered$person_age)
data_filtered$person_emp_exp_log <- log(data_filtered$person_emp_exp)
data_filtered$loan_amnt_log <- log(data_filtered$loan_amnt)
data_filtered$loan_int_rate_log <- log(data_filtered$loan_int_rate)
data_filtered$loan_percent_income_log <- log(data_filtered$loan_percent_income)
data_filtered$cb_person_cred_hist_length_log <- log(data_filtered$cb_person_cred_hist_length)
data_filtered$credit_score_log <- log(data_filtered$credit_score)
data_filtered$loan_status_log <- (data_filtered$loan_status)
...
```{r}
lillie.test(data_filtered$person_income_log)
lillie.test(data_filtered$person_age_log)
#lillie.test(data_filtered$person_emp_exp_log)
lillie.test(data_filtered$loan_amnt_log)
lillie.test(data_filtered$loan_int_rate_log)
#lillie.test(data_filtered$loan_percent_income_log)
lillie.test(data_filtered$cb_person_cred_hist_length_log)
lillie.test(data_filtered$credit_score_log)
lillie.test(data_filtered$loan_status_log)
>>>>>>> 3b6b0efa9e15aa4ef4f78a5e3aaac332db43e3b9
