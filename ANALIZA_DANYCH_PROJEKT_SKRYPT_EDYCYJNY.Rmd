...
ggplot(data, aes(x = loan_percent_income)) +
  geom_histogram(binwidth = 10000, fill = "red", color = "black", alpha = 0.7) +
  labs(title = "Histogram dochodu", x = "Dochód", y = "Częstość") +
  theme_minimal()



ggplot(data, aes(x = person_emp_exp)) +
  geom_histogram(binwidth = 10000, fill = "black", color = "black", alpha = 0.7) +
  labs(title = "Histogram dochodu", x = "Dochód", y = "Częstość") +
  theme_minimal()
...
ggplot(data, aes(x = credit_score)) +
  geom_histogram(binwidth = 10000, fill = "green", color = "black", alpha = 0.7) +
  labs(title = "Histogram dochodu", x = "Dochód", y = "Częstość") +
  theme_minimal()
